...
export function DeleteService({ service, isOpen, setOpenModal }: DeleteServiceProps) {
    ...
    const handleSubmit = async (values: typeof initialValues, action: any) => {
        ...
        const promisse = await serviceDelete(service.serviceId)
                                ...
                                <form onSubmit={handleSubmit} target="_self">
                                    ...
                                    <div className='flex flex-col mt-2'>
                                        ...
                                        <input className='border rounded-md border-lightgray shadow-sm p-2'
                                            ...
                                            placeholder={service.serviceCost.toString()}
                                            disabled />
                                    </div>                                  
                                    ...
                                    <div className='flex gap-8 items-end justify-items-end mb-5'>
                                        <div className='mt-2 flex flex-col w-2/6'>
                                            ...
                                            <input className='border rounded-md border-lightgray shadow-sm p-2'
                                                ...
                                                placeholder={service.endDate?.toString()}
                                                disabled
                                            />
                                        </div>                                       
                                    </div>
